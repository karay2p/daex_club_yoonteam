...
import { StatCard, Card, Badge, LoadingSpinner, ProgressBar } from '@/components/ui'
    ...
    <DashboardLayout title="대시보드">
      ...
      <div className="relative mb-6 rounded-2xl overflow-hidden bg-brand-gradient p-6 md:p-8 text-white shadow-lg shadow-brand-200/40">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-2xl md:text-3xl font-bold leading-tight mb-2" style={{ fontFamily: 'DM Serif Display, serif' }}>
            안녕하세요, {user.name}님! 👋
          </h2>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <StatCard
          title="오늘 출석"
          value={`${attendance.length}/${totalMembers}`}
          subtitle="출석 완료"
          icon={CheckSquare}
          color="green"
        />
                ...
                <Link key={notice.id} href="/notices" className="flex items-start gap-4 px-6 py-4 hover:bg-gray-50/70 transition-colors group">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                      ...
                      {notice.is_pinned && <Badge variant="info">고정</Badge>}
                    </div>
                  ...
                  return (
                    <div
                      ...
                      className={`w-9 h-9 rounded-full flex items-center justify-center text-xs font-bold border-2 transition-all ${
                        checked
                          ? 'bg-brand-gradient text-white border-brand-300 shadow-sm shadow-brand-200'
