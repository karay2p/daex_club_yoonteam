...
import {
  ...
  Settings, LogOut, ChevronRight, Shield, Upload
} from 'lucide-react'

const navItems = [
  { href: '/dashboard', icon: LayoutDashboard, label: '대시보드', roles: ['admin', 'member', 'observer'] },
  { href: '/notices', icon: Bell, label: '공지사항', roles: ['admin', 'member', 'observer'] },
  { href: '/schedule', icon: Calendar, label: '스케줄', roles: ['admin', 'member', 'observer'] },
  { href: '/missions', icon: Target, label: '미션', roles: ['admin', 'member', 'observer'] },
  { href: '/submissions', icon: Upload, label: '미션 인증', roles: ['admin', 'member', 'observer'] },
  { href: '/attendance', icon: CheckSquare, label: '출석 체크', roles: ['admin', 'member', 'observer'] },
  { href: '/members', icon: Users, label: '팀원 현황', roles: ['admin', 'member', 'observer'] },
  { href: '/admin', icon: Settings, label: '관리자', roles: ['admin'] },
]
